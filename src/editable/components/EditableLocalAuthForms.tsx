...
const inputClass = 'h-12 rounded-2xl border border-[#1d1830]/10 bg-white px-4 text-base font-bold text-black outline-none transition placeholder:text-black/35 focus:border-current'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-2xl bg-[#1d1830] px-6 text-sm font-black uppercase tracking-[0.18em] text-[#f6f3eb] shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
