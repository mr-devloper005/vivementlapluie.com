...
export function EmptyState({
  ...
  return (
    <section className={cn('rounded-[2rem] border border-[#1d1830]/10 bg-white p-8 text-center shadow-[0_14px_36px_rgba(20,14,35,0.05)]', className)}>
      ...
      <Link href={actionHref} className="mt-6 inline-flex items-center gap-2 rounded-xl border border-current/15 px-5 py-3 text-sm font-semibold transition hover:bg-current hover:text-background">
        {actionLabel}
