...
export default function SignupPage() {
  return (
    <EditableSiteShell>
      <main className="editable-dark-grid bg-[#1d1830] text-[#f6f3eb]">
        <section className="mx-auto grid min-h-[calc(100vh-12rem)] max-w-[1180px] items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[0.9fr_1fr] lg:px-8">
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.08] p-6 shadow-[0_24px_70px_rgba(20,14,35,0.18)] backdrop-blur sm:p-8">
          ...
          <div>
            <p className="text-xs font-black uppercase tracking-[0.28em] text-[#c9caac]">{pagesContent.auth.signup.badge}</p>
            <h2 className="mt-5 max-w-xl text-5xl font-black leading-[0.9] tracking-[-0.07em] sm:text-6xl">{pagesContent.auth.signup.title}</h2>
